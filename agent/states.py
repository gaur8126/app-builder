...
class CoderState(BaseModel):
    ...
    current_state_idx: int = Field(description="The index of the current step in the implementation steps.")
    current_file_content: Optional[str] = Field(None, description="The content of the file currently being edits or created.")